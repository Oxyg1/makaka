...
const STRINGS = {
  ru: {
    ...
    'menu.upgrades':      'Магазин',

    'upgrades.title':     'Магазин апгрейдов',
    'upgrades.level':     'Ур. {n}',
    'upgrades.max':       'Макс',
    'upgrades.tapHint':   'Жми по пустым клеткам пруда — получай монеты.',
    'upgrade.tapPower.name':      'Сила касания',
    'upgrade.tapPower.desc':      '+1 монета за каждый тап по пруду.',
    'upgrade.mergeBonus.name':    'Бонус слияния',
    'upgrade.mergeBonus.desc':    '+1 монета за каждое слияние.',
    'upgrade.spawnDiscount.name': 'Скидка на призыв',
    'upgrade.spawnDiscount.desc': '−5% к цене призыва лягушки.',
    'upgrade.idleIncome.name':    'Доход во сне',
    'upgrade.idleIncome.desc':    '+1 монета в минуту даже офлайн.',

    'tap.reward':         '+{n}',
    'idle.welcome':       'Пока тебя не было: +{n}',
  ...
  en: {
    ...
    'upgrades.title':     'Upgrade shop',
    'upgrades.level':     'Lv {n}',
    'upgrades.max':       'Max',
    'upgrades.tapHint':   'Tap empty lily pads to earn coins.',
    'upgrade.tapPower.name':      'Tap power',
    'upgrade.tapPower.desc':      '+1 coin per pond tap.',
    'upgrade.mergeBonus.name':    'Merge bonus',
    'upgrade.mergeBonus.desc':    '+1 coin per merge.',
    'upgrade.spawnDiscount.name': 'Spawn discount',
    'upgrade.spawnDiscount.desc': '−5% off frog spawn cost.',
    'upgrade.idleIncome.name':    'Idle income',
    'upgrade.idleIncome.desc':    '+1 coin per minute, even offline.',

    'tap.reward':         '+{n}',
    'idle.welcome':       'While you were away: +{n}',
